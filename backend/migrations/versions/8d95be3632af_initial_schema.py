...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_model_capabilities_model_name'), 'model_capabilities', ['model_name'], unique=False)
    ...
    op.create_index(op.f('ix_organization_api_keys_workspace_id'), 'organization_api_keys', ['workspace_id'], unique=False)
    ...
    op.create_index(op.f('ix_organization_models_workspace_id'), 'organization_models', ['workspace_id'], unique=False)
    ...
    op.create_index(op.f('ix_user_activities_user_id'), 'user_activities', ['user_id'], unique=True)
    ...
    op.create_index(op.f('ix_messages_generation_id'), 'messages', ['generation_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_organization_models_workspace_id'), table_name='organization_models')
    op.drop_table('organization_models')
    op.drop_index(op.f('ix_organization_api_keys_workspace_id'), table_name='organization_api_keys')
    ...
    op.drop_index(op.f('ix_model_capabilities_model_name'), table_name='model_capabilities')
