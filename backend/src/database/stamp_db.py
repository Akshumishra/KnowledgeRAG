...
async def stamp_if_needed():
    ...
    async with engine.begin() as conn:
        ...
        result2 = await conn.execute(text("SELECT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'alembic_version');"))
        ...
        if is_initialized and not has_alembic:
            ...
            await conn.execute(text("INSERT INTO alembic_version (version_num) VALUES ('8d95be3632af');"))
